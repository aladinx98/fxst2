...
quiz_status = True
quiz_list = [
    {"question": "Which wallet types are compatible with the FXST Token?", "answer": "BEP20 wallets", "options": ["BEP20 wallets", "ERC20 wallets only", "Bitcoin wallets", "Hardware wallets only"]},
    {"question": "What special event is planned before Round 2 of the FXST Airdrop?", "answer": "Play & Win Game (Neon Blaster)", "options": ["Community AMA", "Play & Win Game (Neon Blaster)", "NFT Launch", "Polkadot"]},
    {"question": "What is the name of the Telegram bot used to participate in the FXST Airdrop?", "answer": "@FXSTAirdropBot", "options": ["@FXSTGiveawayBot", "@FXSTTokenBot", "@FXSTAirdropBot", "@FXSTCommunityBot"]},
    {"question": "Which of the following actions is required to participate in the FXST Airdrop?", "answer": "Join FXST Telegram Channel", "options": ["Write a blog post", "Join FXST Telegram Channel", "Purchase FXST Tokens", "Create an NFT"]},
    {"question": "What is the total prize pool for the FXST Grand Airdrop?", "answer": "$50,000", "options": ["$10,000", "$25,000", "$50,000", "$100,000"]},
    {"question": "What is the process of verifying transactions in a blockchain called?", "answer": "Mining", "options": ["Mining", "Staking", "Farming", "Proofing"]},
    {"question": "Which of the following is a layer 2 scaling solution for Ethereum?", "answer": "Polygon", "options": ["Polkadot", "Chainlink", "Polygon", "Cardano"]},
    {"question": "Which term refers to a significant drop in cryptocurrency prices?", "answer": "Bear Market", "options": ["Bull Market", "Bear Market", "Whale Market", "Mooning"]},
    {"question": "What is the term for when a blockchain is divided into two separate chains?", "answer": "Forking", "options": ["Splitting", "Sharding", "Forking", "Merging"]},
    {"question": "What is the name of the first decentralized stablecoin?", "answer": "Dai (DAI)", "options": ["Tether (USDT)", "Dai (DAI)", "USD Coin (USDC)", "Binance USD (BUSD)"]}
]
